...
import com.junzijian.framework.common.annotation.Limiter;
...
//        String methodType = requestMapping.methodType;
        ...
        // 唯一：登录用户SessionId + 参数
        String user = "TODO 登录用户SessionId" // SecurityUtils.getSubject().getSession().getId().toString()
    ...
    private boolean doLimiter(String route, String userHash, Integer limit, int expire) {
        ...
        Boolean result = stringRedisTemplate.execute(redisScript, Lists.newArrayList(key),
