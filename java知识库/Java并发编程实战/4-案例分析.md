...
```             
        ...
        Reactor 模式：
            ...
            Synchronous Event Demultiplexer      ==>     操作系统 提供的 I/O 多路复用API
            ...
            详述：
                其中 Handle 指的是 I/O句柄，在 Java网络编程里，它 本质上 就是 一个网络连接
                
                Event Handler 很容易理解，就是一个事件处理器，
                
                    其中 handle_event() ⽅法 处理 I/O 事件，也就是 每个 Event Handler  处理  一个 I/O Handle
